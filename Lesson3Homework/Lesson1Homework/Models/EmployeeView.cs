...
namespace Lesson1Homework.Models
{
    public class EmployeeView
    {
        ...
        [Display(Name ="Имя")]
        [StringLength(maximumLength:2, MinimumLength =50, ErrorMessage ="Длина имени от 2 до 50 символов")]
        public string FirstName { get; set; }

        [Required(AllowEmptyStrings = false, ErrorMessage = "Фамилия обязательна")]
        [Display(Name = "Фамилия")]
        [StringLength(maximumLength: 2, MinimumLength = 50, ErrorMessage = "Длина фамилии от 2 до 50 символов")]
